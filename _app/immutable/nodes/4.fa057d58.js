import{d as c}from"../chunks/environment.9aa685ef.js";import{s as h,n as r}from"../chunks/scheduler.e108d1fd.js";import{S as u,i as p,s as m,g as d,z as g,f as o,c as f,h as b,x,k as y,a as n}from"../chunks/index.bad58c3a.js";const v=c,_=!0,q=Object.freeze(Object.defineProperty({__proto__:null,csr:v,prerender:_},Symbol.toStringTag,{value:"Module"})),w=""+new URL("../assets/github-logo.7a0dd11e.svg",import.meta.url).href,j=""+new URL("../assets/leetcode-logo.7f79a850.svg",import.meta.url).href,T=""+new URL("../assets/codeforces-logo.ea7f6f0b.svg",import.meta.url).href,k=""+new URL("../assets/mathse-logo.6f416689.svg",import.meta.url).href;function L(l){let a,e,i=`<h1 class="text-center text-3xl font-bold">My (programming) projects are listed below</h1> <div class="mx-auto justify-center flex flex-row gap-5 py-4 w-56"><a href="https://github.com/jorisperrenet" target="_blank"><img class="opacity-80 hover:opacity-100 h-10 w-10" src="${w}" alt="GitHub"/></a> <a href="https://leetcode.com/JorisPerrenet/" target="_blank"><img class="opacity-80 hover:opacity-100 h-10 w-10" src="${j}" alt="LeetCode"/></a> <a href="https://codeforces.com/profile/Joris_Perrenet" target="_blank"><img class="opacity-80 hover:opacity-100 h-10 w-10" src="${T}" alt="CodeForces"/></a> <a href="https://math.stackexchange.com/users/1049661/jorisperrenet" target="_blank"><img class="opacity-80 hover:opacity-100 h-10 w-10" src="${k}" alt="MathSE"/></a></div> <a href="https://projecteuler.net/about" target="_blank"><img class="opacity-80 hover:opacity-100 mx-auto justify-center" src="https://projecteuler.net/profile/Joris_Perrenet.png" alt="Project Euler"/></a> <ul class="list-disc m-auto px-8 py-8 space-y-4"><li><a class="text-blue-600 underline" href="https://github.com/jorisperrenet/durak">durak</a>
            —
            ...
            a detailed instruction on how to install and configure Arch Linux.</li> <li><a class="text-blue-600 underline" href="https://github.com/jorisperrenet/Bachelor Thesis">Bachelor Thesis</a>
            —
            ...
            all the styling I used.</li></ul>`;return{c(){a=m(),e=d("div"),e.innerHTML=i,this.h()},l(t){g("svelte-15mlo1m",document.head).forEach(o),a=f(t),e=b(t,"DIV",{class:!0,"data-svelte-h":!0}),x(e)!=="svelte-11tqog4"&&(e.innerHTML=i),this.h()},h(){document.title="Joris' projects",y(e,"class","text-justify w-full max-w-4xl mx-auto px-10 my-10 text-lg")},m(t,s){n(t,a,s),n(t,e,s)},p:r,i:r,o:r,d(t){t&&(o(a),o(e))}}}class P extends u{constructor(a){super(),p(this,a,null,L,h,{})}}export{P as component,q as universal};
